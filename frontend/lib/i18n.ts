...
export const STRINGS: Record<TargetLanguage, Strings> = {
  en: {
    ...
    orderTotalNote: "Estimate based on listed prices — items priced by weight (/斤) may vary. USD at ≈¥6.77/$ for reference only.",
  ...
  ja: {
    ...
    orderTotal: "合計（目安）",
    orderTotalNote: "表示価格に基づく目安です。量り売り（/斤）の料理は変動する場合があります。米ドルは約¥6.77/$換算の参考値です。",
